...
describe("TodoController.getTodoById", () => {
    ...
    it("should call TodoModel.findById with router parameters", async () => {
        req.params.todoId = "662a3d1afc5c83fe03dc5b59"
        await TodoController.getTodoById(req, res, next);
        expect(TodoModel.findById).toBeCalledWith("662a3d1afc5c83fe03dc5b59")
    })
    it("should return todo and with status code 200", async () => {
